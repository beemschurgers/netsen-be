...
from .enhanced_packet_capture import enhanced_analyzer

# Global packet analyzer instance
packet_analyzer = enhanced_analyzer

async def packet_capture_websocket(websocket: WebSocket):
    """Enhanced packet capture WebSocket with fallback support"""
    ...
    try:
        await websocket.send_json({
            ...
            "message": f"Using {packet_analyzer.capture_method or 'no'} packet capture method"
        })
    except:
        pass
